...
class HikeService
{
    ...
    {
        // todo-X refactor controller into this.
        ...
        // could use actions, but reddit guy said fuck that. And honestly I might just leave the controller with all the logic.. does not seem worth atm
    }
}
